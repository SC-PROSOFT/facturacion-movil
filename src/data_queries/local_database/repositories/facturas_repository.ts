...
class FacturasRepository implements IRepository<IOperation | IOperationDb> {
  async createTable(): Promise<boolean> {
    ...
    CREATE TABLE IF NOT EXISTS facturas (
        ...
        tercero_rut_pdf VARCHAR(255),
        tercero_camcom_pdf VARCHAR(255),
  ...
  async create(factura: IOperation): Promise<boolean> {
   ...
   `;
    ...
    const valuesFactura = [
      ...
      factura.tercero.rut_pdf,
      factura.tercero.camcom_pdf,
  ...
  async update(id: string, item: IOperation): Promise<boolean> {
    ...
    UPDATE facturas SET
      ...
      tercero_rut_pdf='${item.tercero.rut_pdf}',
      tercero_camcom_pdf='${item.tercero.camcom_pdf}',
              ...
              .map((factura: IOperationDb) => {
                return {
                  ...
                  tercero: {
                    ...
                    camcom_pdf: factura.tercero_camcom_pdf,
